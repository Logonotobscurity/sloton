...
const StrategicPartnerTextContent = () => (
    ...
    >
        ...
        <motion.h2 variants={textContentVariants} className="font-headline text-fluid-xl font-bold !leading-snug">
            Make an Impact. Do More with Less.
        </motion.h2>
        <motion.p variants={textContentVariants} className="text-muted-foreground text-fluid-base">

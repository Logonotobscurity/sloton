...
const technologies = [
    ...
    { name: 'Azure', icon: 'https://img.icons8.com/color/96/azure-storage-explorer.png', dataAiHint: "Microsoft Azure logo" },
    ...
    { name: 'OpenAI', icon: 'https://img.icons8.com/nolan/96/openai-logo.png', dataAiHint: "OpenAI logo" },
    ...
    { name: 'Hugging Face', icon: 'https://cdn-uploads.huggingface.co/production/uploads/60f1abe7544c2adfd6397992/q4oBD2W-1I0T5s2n5mO2m.png', dataAiHint: "Hugging Face logo" },

...
<ul class="list-disc pl-6 space-y-2 mb-6">
    ...
    <li><a href="https://www.reuters.com/technology/asmls-new-500-mln-euv-machine-is-size-double-decker-bus-2023-12-21/" target="_blank" rel="noopener noreferrer" class="text-primary hover:underline">$200+ million per machine</a> for standard EUV, $350-400 million for High-NA EUV</li>
...
<ul class="list-disc pl-6 space-y-2 mb-6">
    <li><b>Moat Strength:</b> CUDA software ecosystem is incredibly sticky—90% of AI developers use CUDA, creating a massive switching cost</li>
    <li><b>Scale Advantages:</b> The bigger they get, the more R&D they can fund</li>
    <li><b>Next-Gen Catalyst:</b> <a href="https://developer.nvidia.com/blog/nvidia-blackwell-platform-arrives-to-power-a-new-era-of-computing/" target="_blank" rel="noopener noreferrer" class="text-primary hover:underline">Blackwell chips delivering 2.5x performance improvement</a> over previous generation</li>

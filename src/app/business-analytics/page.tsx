      ...
      <div className="container mx-auto px-4 md:px-6 py-24 sm:py-32">
        <section className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h1 className="text-4xl md:text-5xl font-bold">Business Analytics & Intelligence</h1>
          ...
          <div className="relative h-96">
            ...
            <Card className="absolute inset-5 bg-background/80 backdrop-blur-lg rotate-2 transition-transform duration-300 ease-in-out hover:rotate-0 hover:scale-105">
                 <CardHeader>
                    ...
                    <CardTitle className="text-center text-3xl">Actionable Insights</CardTitle>
                    <CardDescription className="text-center">
                        Transforming numbers into narrative.
                    </CardDescription>
                </CardHeader>
                <CardContent className="text-center text-muted-foreground">
                    <p>We connect to your data sources to build a clear picture of your business performance and potential.</p>
                </CardContent>
            </Card>
          </div>
        </section>
        ...
        <section className="py-24">
            <div className="text-center max-w-3xl mx-auto mb-16">
                <h2 className="text-3xl md:text-4xl font-bold">Our Business Analytics Services</h2>

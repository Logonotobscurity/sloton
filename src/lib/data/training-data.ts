...
export const trainingBenefits = [
    { icon: Award, text: 'Industry Expert Instructors' },
    { icon: BookOpen, text: 'Hands-on, Project-Based Learning' },
    { icon: TrendingUp, text: 'Career Advancement Support' },
    { icon: Users, text: 'Access to a Professional Community' },
];